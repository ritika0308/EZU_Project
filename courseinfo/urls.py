...
from courseinfo.views import (
    InstructorList, SectionList, SemesterList, CourseList, StudentList, RegistrationList, InstructorDetail,
    SectionDetail, SemesterDetail, StudentDetail, RegistrationDetail, CourseDetail, InstructorCreate,
    SectionCreate, CourseCreate, StudentCreate, SemesterCreate, RegistrationCreate, InstructorUpdate, SectionUpdate,
    CourseUpdate, SemesterUpdate, StudentUpdate, RegistrationUpdate, RegistrationDelete, InstructorDelete, SectionDelete,
    CourseDelete, SemesterDelete, StudentDelete,
)
